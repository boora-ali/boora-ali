...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-background p-3 [--cell-size:2.25rem] [[data-slot=popover-content]_&]:bg-transparent",
        className
      )}
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "border-input bg-background shadow-xs relative rounded-md border",
        ...
        caption_label: cn(
          "flex h-8 items-center gap-1 rounded-md pl-2 pr-1 text-sm font-medium",
