...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap border-[3px] border-foreground text-sm font-bold ring-offset-background shadow-[4px_4px_0_var(--color-shadow)] transition-[transform,box-shadow,background-color,color] focus-visible:outline-[3px] focus-visible:outline-offset-2 focus-visible:outline-primary disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
