...
class AuthRateThrottle(ScopedRateThrottle):
    ...
    def __init__(self):
        # Use the active default cache for the current settings context.
        # DRF binds the cache backend at import time, which breaks tests that
        # override CACHES after the module is loaded.
